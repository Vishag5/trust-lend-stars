...
async def run_test():
    ...
    try:
        ...
        # Select Borrower A to proceed with contract creation and verification.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div[2]/div/div[2]/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click 'Create New Contract' button to start creating a new contract.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div[2]/main/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Fill in lender phone number, loan amount, reason, repayment date, and submit the loan request.
        frame = context.pages[-1]
        ...
        # Select a repayment date within the allowed range (minimum 48 hours from now, maximum 90 days) and submit the loan request.
        frame = context.pages[-1]
        ...
        # Fill the repayment time field to complete the repayment date and submit the loan request again.
        frame = context.pages[-1]
        ...
        # Select a valid repayment date at least 48 hours from now and within 90 days, then submit the loan request again.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div[2]/main/div/form/div[2]/div[3]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div[2]/main/div/form/div[2]/div[3]/div').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
