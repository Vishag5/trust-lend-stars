...
async def run_test():
    ...
    try:
        ...
        # Select Borrower A to proceed to the app.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div[2]/div/div[2]/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click on 'Create New Contract' button to navigate to contract creation page.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div[2]/main/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Input loan amount less than Rs.100 and attempt to submit to observe validation error.
        frame = context.pages[-1]
        ...
        # Clear amount field, input valid amount (e.g., 500), then select a due date less than 48 hours from now and attempt to submit to observe validation error.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div[2]/main/div/form/div[2]/div/div/input').nth(0)
        ...
        # Select a due date less than 48 hours from current date (2025-10-03) and attempt to submit to observe validation error.
        frame = context.pages[-1]
        ...
        # Set due date more than 90 days from now and attempt to submit to observe validation error.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div[2]/main/div/form/div[2]/div[3]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        # Input lender phone number not in +91 format and attempt to submit to observe validation error.
        frame = context.pages[-1]
        ...
        assert False, 'Test plan execution failed: loan contract creation did not fail as expected for invalid inputs.'
