...
async def run_test():
    ...
    try:
        ...
        # Select a demo user to continue and create contract data while online.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div[2]/div/div[2]/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click 'Request Loan' button to create and save contract data while online.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div[2]/main/div[4]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Fill in loan request form fields and submit the loan request.
        frame = context.pages[-1]
        ...
        # Select repayment date October 7, 2025 (index 17) and submit the loan request.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div[2]/div/div/div/div/table/tbody/tr[2]/td[3]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click 'Send Loan Request' button to save contract data while online.
        frame = context.pages[-1]
